...
/**
 * &lt;p&gt;Java class for ArrayOfFECAEADetRequest complex type&lt;/p&gt;.
 * 
...
public class ArrayOfFECAEADetRequest {
     ...
     * This is why there is not a {@code set} method for the fecaeaDetRequest property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the fecaeaDetRequest property.
     */
    public List<FECAEADetRequest> getFECAEADetRequest() {
        if (fecaeaDetRequest == null) {
            fecaeaDetRequest = new ArrayList<>();
        }
